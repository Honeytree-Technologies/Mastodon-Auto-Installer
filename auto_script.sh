...
echo "Your admin user name is, \$admin_user"

read -p "Enter admin email: " admin_email
echo "Your admin email is, \$admin_email"

read -p "Enter valid domain name: " domain_name
echo "Your domain is, \$domain_name"

# Loop until valid numerical input is provided
while true; do
...
SMTP_PORT=<enter-your-smtp-port-here>
SMTP_LOGIN=<enter-your-smtp-login-here>
SMTP_PASSWORD=<enter-your-password-here>
SMTP_FROM_ADDRESS=<enter-your-smtp-email-here>
S3_ENABLED=false
